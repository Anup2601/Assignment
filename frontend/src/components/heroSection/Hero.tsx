...
function Hero() {
  return (
    <main className="overflow-hidden relative m-5 ml-8 max-w-6xl bg-blue-600 rounded-3xl h-[524px] max-md:p-5 max-md:h-auto max-md:max-w-[991px] max-md:min-h-[524px] max-sm:p-4 max-sm:max-w-screen-sm max-sm:rounded-2xl">
